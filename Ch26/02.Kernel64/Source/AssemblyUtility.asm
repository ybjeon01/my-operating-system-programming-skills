...
global kInPortDword, kOutPortDword
...
; this function follows IA-32e mode function convention
; param:
;   port address (dword): memory address where data is stored
; return:
...
; this function follows IA-32e mode function convention
; param:
;   port address (dword): I/O port address to write data
